                ...
                <div className="flex flex-row items-center">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      Cookies.set('sp', savedPassword, { expires: 7, domain: localhost_domain, httpOnly: true, secure: true, sameSite: 'strict'})
                      Cookies.set('se', savedEmail, { expires: 7, domain: localhost_domain, httpOnly: true, secure: true, sameSite: 'strict'})
                      if (!e.target.checked) {
