            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-9">
              <div className="flex items-center justify-center h-28 grid-item">
                <div>
                  ...
                  <h1 className="text-black data-size">{beanCount.bad} pieces</h1>
                </div>
              </div>
              <div className="flex items-center justify-center h-28 grid-item">
                <div>
                  ...
                  <h1 className="text-black data-size">{beanCount.good} pieces</h1>
                </div>
              </div>
              <div className="flex items-center justify-center h-28 grid-item">
                <div>
                  <h1 className="text-black data-title">KG of Bad Beans</h1>
                  <h1 className="text-black data-size">{beanCount.kilograms} kilograms</h1>
                </div>
              </div>
            </div>
          </div>
