            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {sortedData.map((sorted) => (
                  <tr key={sorted.id}>
                    <td className="px-6 py-4 whitespace-nowrap">{sorted.date}</td>
                    <td className="px-6 py-4 whitespace-nowrap">{sorted.sorterName}</td>
                    <td className="px-6 py-4 whitespace-nowrap">{sorted.customerName}</td>
                    <td className="px-6 py-4 whitespace-nowrap">{sorted.status}</td>
