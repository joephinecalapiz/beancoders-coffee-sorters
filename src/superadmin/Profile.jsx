          ...
          <div className={`p-4 ${navVisible ? "ml-0" : ""}`}>
            ...
            >
              <div className="flex flex-col items-center justify-center">
                ...
                <label className="poppins-font admin-name text-black dark:text-textTitle poppins-font justify-center bg-gray-1000 drop-shadow-2xl">
                  {profileData.name}
                </label>

                <label className="poppins-font font-bold admin-label text-black dark:text-textDesc poppins-font mb-5 justify-center drop-shadow-4xl">
                  Super Admin
                </label>
              </div>
            </div>
                ...
                <div className="flex items-center justify-center sm:justify-self-end">
                  {isEditing ? (
                    <div className="profile-edit-buttons">
                      <button
                        className="poppins-font bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-full mr-2"
                        onClick={handleSaveClick}
                      >
                        Save
                      </button>
                      <button
                        className="poppins-font bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-full"
                    ...
                    <button
                      className="poppins-font  bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-full"
                  ...
                  <div className="mobile:px-5 mt-5">
                    <div>
                      <div className="px-4 sm:px-0 align-center justify-center">
                        <h3 className="poppins-font text-base font-semibold leading-7 text-gray-900 dark:text-textTitle">
                          Admin Information
                        </h3>
                        <p className="poppins-font mt-1 max-w-2xl text-sm leading-6 text-gray-500 dark:text-textDesc">
                          Admin details.
                        </p>
                      </div>
                      <div className="mt-6 border-t border-gray-100">
                        <div className="divide-y divide-gray-100">
                          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            <dt className="poppins-font text-sm font-semibold leading-6 text-gray-900 dark:text-textTitle">
                              Full name
                            </dt>
                            {isEditing ? (
                              ...
                              <dd className="poppins-font mt-1 text-sm dark:text-textDesc leading-6 sm:col-span-2 sm:mt-0 justify-self-end">
                                {profileData.name}
                              </dd>
                            )}
                          </div>
                          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            ...
                            <dd className="poppins-font mt-1 text-sm leading-6 text-gray-900 dark:text-textDesc sm:col-span-2 sm:mt-0 justify-self-end">
                              Admin
                            </dd>
                          </div>
                          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            ...
                            {isEditing ? (
                              ...
                              <dd className="poppins-font mt-1 text-sm leading-6 sm:col-span-2 dark:text-textDesc sm:mt-0 justify-self-end">
                                {profileData.email}
                              </dd>
                            )}
                          </div>
                  ...
                  <div className="mobile:px-5 mt-5">
                    <div>
                      ...
                      <div className="mt-6 border-t border-gray-100">
                        <div className="divide-y divide-gray-100">
                          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            <dt className="poppins-font text-sm font-semibold leading-6 text-gray-900 align-center self-center dark:text-textTitle">
                              Company Name
                            </dt>
                            {isEditing ? (
                              <div className="flex sm:col-span-2 sm:mt-0 justify-self-end relative">
                              ...
                              <dd className="poppins-font mt-1 text-sm leading-6 bg-transparent dark:text-textDesc sm:col-span-2 sm:mt-0 justify-self-end">
